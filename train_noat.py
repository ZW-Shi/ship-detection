...
from model_recurrent_noat import *
# from models import *
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_weights", type=str, default="weights/new_cornet_s.pth", help="if specified starts from checkpoint model")
    ...
    #logger0 = Logger("logs")
    logger = get_logger(os.path.join(opt.log + 'YOLOv3-recurrent_NoAttention.log'))
    ...
    for epoch in range(opt.epochs):
        ...
        if epoch % opt.evaluation_interval == 0:
            ...
            precision, recall, AP, f1, ap_class, val_loss_l = evaluate(
                model,
				device,
                path=valid_path,
                iou_thres=0.5,
